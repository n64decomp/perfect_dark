...
struct mptrack g_MpTracks[NUM_MPTRACKS] = {
	...
	/*0x07*/ { 0x09, 120, 0x5883,  0 },
	/*0x08*/ { 0x10, 120, 0x5884,  0 },
	/*0x09*/ { 0x12, 120, 0x5885,  1 },
	/*0x0a*/ { 0x13, 120, 0x5886,  1 },
	/*0x0b*/ { 0x02, 120, 0x5887,  2 },
	/*0x0c*/ { 0x11, 120, 0x5888,  2 },
	/*0x0d*/ { 0x0c, 120, 0x5889,  3 },
	/*0x0e*/ { 0x27, 120, 0x588a,  3 },
	/*0x0f*/ { 0x0e, 120, 0x588b,  4 },
	/*0x10*/ { 0x28, 120, 0x588c,  4 },
	/*0x11*/ { 0x0f, 120, 0x588d,  5 },
	/*0x12*/ { 0x29, 120, 0x588e,  5 },
	/*0x13*/ { 0x14, 120, 0x588f,  6 },
	/*0x14*/ { 0x2a, 120, 0x5890,  6 },
	/*0x15*/ { 0x16, 120, 0x5891,  7 },
	/*0x16*/ { 0x32, 120, 0x5892,  7 },
	/*0x17*/ { 0x06, 120, 0x5893,  8 },
	/*0x18*/ { 0x33, 120, 0x5894,  8 },
	/*0x19*/ { 0x17, 120, 0x5895,  9 },
	/*0x1a*/ { 0x34, 120, 0x5896,  9 },
	/*0x1b*/ { 0x18, 120, 0x5897, 10 },
	/*0x1c*/ { 0x35, 120, 0x5898, 10 },
	/*0x1d*/ { 0x1d, 120, 0x5899, 11 },
	/*0x1e*/ { 0x1e, 120, 0x589a, 11 },
	/*0x1f*/ { 0x1c, 120, 0x589b, 12 },
	/*0x20*/ { 0x36, 120, 0x589c, 12 },
	/*0x21*/ { 0x07, 120, 0x589d, 13 },
	/*0x22*/ { 0x37, 120, 0x589e, 13 },
	/*0x23*/ { 0x04, 120, 0x589f, 14 },
	/*0x24*/ { 0x24, 120, 0x58a0, 14 },
	/*0x25*/ { 0x1f, 120, 0x58a1, 15 },
	/*0x26*/ { 0x20, 120, 0x58a2, 15 },
	/*0x27*/ { 0x21, 120, 0x58a3, 16 },
	/*0x28*/ { 0x38, 120, 0x58a4, 16 },
	/*0x29*/ { 0x58, 120, 0x58a5, 16 },
};
