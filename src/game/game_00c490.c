...
/*  f00c58c:	3c018007 */ 	lui	$at,%hi(g_AlarmActive)
/*  f00c590:	ac2098d4 */ 	sw	$zero,%lo(g_AlarmActive)($at)
/*  f00c594:	3c018007 */ 	lui	$at,%hi(var800698d8)
/*  f00c598:	ac2098d8 */ 	sw	$zero,%lo(var800698d8)($at)
