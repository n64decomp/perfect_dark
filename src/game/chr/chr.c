...
/*  f01f568:	0fc1984a */ 	jal	0xf066128
...
/*  f01f580:	0fc19841 */ 	jal	0xf066104
...
.PF0f01f6f4:
/*  f01f6f4:	0fc64cac */ 	jal	0xf1932b0
...
/*  f01f944:	0fc32fa5 */ 	jal	0xf0cbe94
...
/*  f01fc98:	0fc0f072 */ 	jal	0xf03c1c8
...
/*  f01fdfc:	0fc1968d */ 	jal	0xf065a34
...
.PF0f01fe48:
/*  f01fe48:	0fc07a45 */ 	jal	0xf01e914
...
/*  f01feb0:	0fc07ce1 */ 	jal	0xf01f384
...
/*  f01ff18:	0fc07ce1 */ 	jal	0xf01f384
...
/*  f01ff80:	0fc4a513 */ 	jal	0xf12944c
...
/*  f020108:	0fc1968d */ 	jal	0xf065a34
...
/*  f0202b0:	0fc25941 */ 	jal	0xf096504
...
/*  f0202c8:	0fc07ce1 */ 	jal	0xf01f384
...
.PF0f02036c:
/*  f02036c:	0fc63831 */ 	jal	0xf18e0c4
/*  f020370:	02002025 */ 	move	$a0,$s0
/*  f020374:	00402825 */ 	move	$a1,$v0
.PF0f020378:
/*  f020378:	0fc0d930 */ 	jal	0xf0364c0
...
/*  f0204d8:	0fc1968d */ 	jal	0xf065a34
...
.PF0f020598:
/*  f020598:	0fc197b5 */ 	jal	0xf065ed4
/*  f02059c:	00000000 */ 	nop
/*  f0205a0:	27a400fc */ 	addiu	$a0,$sp,0xfc
/*  f0205a4:	0fc1968d */ 	jal	0xf065a34
...
/*  f0205e4:	0fc197b5 */ 	jal	0xf065ed4
		...
		struct coord *pos, s16 *rooms, f32 arg4, u8 *ailist)
{
	...
	modelSetAnimPlaySpeed(model, FRAMESTOTIME60(var80062968), 0);
...
f32 func0f02143c(struct chrdata *chr)
{
	...
	if (chr->hidden2 & CHRH2FLAG_HEADSHOTTED) {
		...
		if (value < 10) {
			value = sinf(value * 1.5705462694168f / 10);
		} else {
			value = 1 - sinf((value - 10) * (PAL ? 0.098159141838551f : 0.078527316451073f));
		}
	}
	...
	if (chr->poisoncounter > 0) {
		...
		if (chr->actiontype == ACT_DEAD || chr->actiontype == ACT_DIE) {
			...
			if (!g_Vars.normmplayerisrunning) {
				...
				if (chr->poisoncounter > 3600) {
					chr->poisoncounter = 3600;
				}
			...
			if (chr->poisoncounter <= 0) {
				...
				chr->poisoncounter = 0;
			} else if (chr->poisoncounter < SECSTOTIME240(7)) {
...
.PF0f023424:
/*  f023424:	0fc089d8 */ 	jal	0xf022760
/*  f023428:	02002025 */ 	move	$a0,$s0
/*  f02342c:	0fc08ba7 */ 	jal	0xf022e9c
...
/*  f023544:	0fc1c248 */ 	jal	0xf070920
/*  f023548:	24050001 */ 	li	$a1,0x1
.PF0f02354c:
/*  f02354c:	8fa40250 */ 	lw	$a0,0x250($sp)
/*  f023550:	0fc08399 */ 	jal	0xf020e64
...
/*  f023570:	0fc0f072 */ 	jal	0xf03c1c8
...
/*  f0235e8:	0fc0888a */ 	jal	0xf022228
...
/*  f023630:	0fc4a513 */ 	jal	0xf12944c
...
.PF0f0237b8:
/*  f0237b8:	0fc23a44 */ 	jal	0xf08e910
...
/*  f023844:	0c006aa7 */ 	jal	0x1aa9c
/*  f023848:	afa20204 */ 	sw	$v0,0x204($sp)
/*  f02384c:	0c006c56 */ 	jal	0x1b158
...
/*  f023964:	0fc0888a */ 	jal	0xf022228
...
/*  f02397c:	0fc0888a */ 	jal	0xf022228
...
/*  f023a58:	0fc0888a */ 	jal	0xf022228
...
/*  f023b0c:	0fc0888a */ 	jal	0xf022228
...
/*  f023b6c:	0fc4a513 */ 	jal	0xf12944c
...
/*  f023c14:	0fc0888a */ 	jal	0xf022228
...
.PF0f023d5c:
/*  f023d5c:	0fc084e5 */ 	jal	0xf021394
...
/*  f023de8:	0fc091e3 */ 	jal	0xf02478c
...
/*  f023f48:	0c00591b */ 	jal	0x1646c
/*  f023f4c:	e7aa0198 */ 	swc1	$f10,0x198($sp)
/*  f023f50:	0fc2d706 */ 	jal	0xf0b5c18
/*  f023f54:	00000000 */ 	nop
/*  f023f58:	00402025 */ 	move	$a0,$v0
/*  f023f5c:	0c0055e3 */ 	jal	0x1578c
...
/*  f023f84:	0fc4a513 */ 	jal	0xf12944c
...
/*  f023fb0:	0fc0f978 */ 	jal	0xf03e5e0
...
/*  f024054:	0c00591b */ 	jal	0x1646c
/*  f024058:	e7b20184 */ 	swc1	$f18,0x184($sp)
/*  f02405c:	0fc2d706 */ 	jal	0xf0b5c18
/*  f024060:	00000000 */ 	nop
/*  f024064:	00402025 */ 	move	$a0,$v0
/*  f024068:	0c0055e3 */ 	jal	0x1578c
...
/*  f0240a8:	0fc5a25d */ 	jal	0xf168974
...
/*  f02410c:	0fc2d736 */ 	jal	0xf0b5cd8
...
/*  f024160:	0fc47e5c */ 	jal	0xf11f970
...
/*  f024354:	0fc1a666 */ 	jal	0xf069998
/*  f024358:	260500fc */ 	addiu	$a1,$s0,0xfc
.PF0f02435c:
/*  f02435c:	0c0069de */ 	jal	0x1a778
...
/*  f024388:	0fc088d4 */ 	jal	0xf022350
...
/*  f0243ec:	0fc22f08 */ 	jal	0xf08bc20
...
/*  f0245ac:	0fc1c260 */ 	jal	0xf070980
...
/*  f024610:	0fc1c248 */ 	jal	0xf070920
...
.PF0f024628:
/*  f024628:	0fc10706 */ 	jal	0xf041c18
...
Gfx *chrRender(struct prop *prop, Gfx *gdl, bool withalpha)
{
	...
	if (chr->aibot && chr->aibot->unk058 > 0) {
		alpha = (f32)alpha * (120 - chr->aibot->unk058) * (PAL ? 0.01f : 0.0083333337679505f);
	}
...
/*  f029a34:	0fc0d042 */ 	jal	0xf034108
...
/*  f029bd4:	0fc5a253 */ 	jal	0xf16894c
...
.PF0f029c98:
/*  f029c98:	0fc5a239 */ 	jal	0xf1688e4
...
/*  f029e00:	0fc2cfb8 */ 	jal	0xf0b3ee0
...
.PF0f029e94:
/*  f029e94:	0fc0a5c7 */ 	jal	0xf02971c
...
/*  f02a0ac:	0fc5a253 */ 	jal	0xf16894c
...
/*  f02a20c:	0fc5a239 */ 	jal	0xf1688e4
...
.PF0f02a72c:
/*  f02a72c:	0fc5a253 */ 	jal	0xf16894c
...
/*  f02a798:	0fc5a239 */ 	jal	0xf1688e4
...
/*  f02a9ac:	0fc5a239 */ 	jal	0xf1688e4
...
.PF0f02aa40:
/*  f02aa40:	0fc5a253 */ 	jal	0xf16894c
...
.PF0f02ab84:
/*  f02ab84:	0fc5a253 */ 	jal	0xf16894c
...
/*  f02af48:	0fc5a253 */ 	jal	0xf16894c
...
/*  f02b07c:	0fc5a239 */ 	jal	0xf1688e4
