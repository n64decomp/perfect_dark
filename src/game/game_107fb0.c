...
s32 menuhandler00108014(u32 operation, struct menu_item *item, s32 *value)
{
	if (operation == MENUOP_CHECKHIDDEN) {
		if (g_MenuStack[g_MpPlayerNum].unke3c_01 > 4) {
			return true;
		}
	}
...
/*  f108338:	3c198007 */ 	lui	$t9,%hi(g_MpPlayerNum)
/*  f10833c:	3c0e8007 */ 	lui	$t6,%hi(g_MpPlayerNum)
/*  f108340:	8dce1448 */ 	lw	$t6,%lo(g_MpPlayerNum)($t6)
/*  f108344:	3c01800a */ 	lui	$at,%hi(g_MenuStack+0xe3c)
...
/*  f10836c:	a022ee3c */ 	sb	$v0,%lo(g_MenuStack+0xe3c)($at)
.L0f108370:
/*  f108370:	8f391448 */ 	lw	$t9,%lo(g_MpPlayerNum)($t9)
/*  f108374:	3c01800a */ 	lui	$at,%hi(g_MenuStack+0xe3c)
...
/*  f10839c:	a038ee3c */ 	sb	$t8,%lo(g_MenuStack+0xe3c)($at)
.L0f1083a0:
...
/*  f10a9dc:	3c09800a */ 	lui	$t1,%hi(var800a19c4)
/*  f10a9e0:	10000038 */ 	beqz	$zero,.L0f10aac4
/*  f10a9e4:	00001025 */ 	or	$v0,$zero,$zero
.L0f10a9e8:
/*  f10a9e8:	8d2919c4 */ 	lw	$t1,%lo(var800a19c4)($t1)
...
/*  f10b7ec:	3c048007 */ 	lui	$a0,%hi(var80071444)
/*  f10b7f0:	8c841444 */ 	lw	$a0,%lo(var80071444)($a0)
...
/*  f10b814:	3c048007 */ 	lui	$a0,%hi(var80071444)
/*  f10b818:	8c841444 */ 	lw	$a0,%lo(var80071444)($a0)
/*  f10b81c:	00402825 */ 	or	$a1,$v0,$zero
/*  f10b820:	0c004dad */ 	jal	sprintf
/*  f10b824:	95e60240 */ 	lhu	$a2,0x240($t7)
/*  f10b828:	8fbf0014 */ 	lw	$ra,0x14($sp)
.L0f10b82c:
/*  f10b82c:	3c028007 */ 	lui	$v0,%hi(var80071444)
/*  f10b830:	8c421444 */ 	lw	$v0,%lo(var80071444)($v0)
