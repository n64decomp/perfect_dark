...
GLOBAL_ASM(
glabel menuRenderItemSeparator
...
/*  f0e9854:	0fc01a40 */ 	jal	colourBlend
...
Gfx *menuRenderItem(Gfx *gdl, struct menuframe *frame)
{
	...
	case MENUITEMTYPE_SEPARATOR:   return menuRenderItemSeparator(gdl);
