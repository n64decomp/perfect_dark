...
/*  f05a3b0:	3c10800a */ 	lui	$s0,%hi(g_Vars)
/*  f05a3b4:	2610e4d0 */ 	addiu	$s0,$s0,%lo(g_Vars)
...
/*  f05a414:	3c0a8007 */ 	lui	$t2,%hi(g_SkedarQuipBank)
/*  f05a418:	254aada8 */ 	addiu	$t2,$t2,%lo(g_SkedarQuipBank)
...
/*  f05a438:	3c0c8007 */ 	lui	$t4,%hi(g_MaianQuipBank)
/*  f05a43c:	146b000d */ 	bne	$v1,$t3,.PB0f05a474
/*  f05a440:	258cade0 */ 	addiu	$t4,$t4,%lo(g_MaianQuipBank)
...
/*  f05a478:	3c0b8007 */ 	lui	$t3,%hi(g_SpecialQuipBank)
/*  f05a47c:	256babe8 */ 	addiu	$t3,$t3,%lo(g_SpecialQuipBank)
...
/*  f05a4ac:	3c098007 */ 	lui	$t1,%hi(g_GuardQuipBank)
/*  f05a4b0:	2529a6c8 */ 	addiu	$t1,$t1,%lo(g_GuardQuipBank)
...
/*  f05a544:	3c0a8007 */ 	lui	$t2,%hi(g_SpecialQuipBank)
...
.PB0f05a560:
/*  f05a560:	254aabe8 */ 	addiu	$t2,$t2,%lo(g_SpecialQuipBank)
...
/*  f05a6bc:	3c017f1b */ 	lui	$at,%hi(var7f1a9d64)
/*  f05a6c0:	c424ba54 */ 	lwc1	$f4,%lo(var7f1a9d64)($at)
...
/*  f05a818:	3c0e8007 */ 	lui	$t6,%hi(g_GuardQuipBank)
...
/*  f05a8a8:	8dc4001c */ 	lw	$a0,%lo(invpartvisibility_crossbow)($t6)
...
/*  f05a9cc:	3c048007 */ 	lui	$a0,%hi(g_SpecialQuipBank+0x16a)
...
/*  f05a9e4:	8484ad52 */ 	lh	$a0,%lo(g_SpecialQuipBank+0x16a)($a0)
...
/*  f05aa24:	3c048007 */ 	lui	$a0,%hi(g_SpecialQuipBank+0x16a)
...
/*  f05aa3c:	8484ad52 */ 	lh	$a0,%lo(g_SpecialQuipBank+0x16a)($a0)
...
.PB0f05aa70:
/*  f05aa70:	25cea6c8 */ 	addiu	$t6,$t6,%lo(g_GuardQuipBank)
...
/*  f05ac94:	3c048007 */ 	lui	$a0,%hi(g_SpecialQuipBank+0x168)
...
/*  f05acb0:	8484ad50 */ 	lh	$a0,%lo(g_SpecialQuipBank+0x168)($a0)
