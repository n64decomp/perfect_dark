...
{
	if (PLAYERCOUNT() == 1 && g_Vars.mplayerisrunning && g_MenuStack[g_Vars.currentplayerstats->mpindex].unk4f8) {
		return true;
	}
...
/*  f18d374:	3c02800a */ 	lui	$v0,%hi(g_MenuCount)
/*  f18d378:	244219c0 */ 	addiu	$v0,$v0,%lo(g_MenuCount)
