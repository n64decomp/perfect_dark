...
GLOBAL_ASM(
glabel func0f167c88
/*  f167c88:	3c0e800a */ 	lui	$t6,%hi(g_Vars+0x34)
/*  f167c8c:	8dce9ff4 */ 	lw	$t6,%lo(g_Vars+0x34)($t6)
...
.L0f167ccc:
/*  f167ccc:	3c05800a */ 	lui	$a1,%hi(g_Vars+0x468)
/*  f167cd0:	8ca5a428 */ 	lw	$a1,%lo(g_Vars+0x468)($a1)
...
/*  f167cf4:	3c05800a */ 	lui	$a1,%hi(g_Vars+0x4cc)
/*  f167cf8:	8ca5a48c */ 	lw	$a1,%lo(g_Vars+0x4cc)($a1)
...
/*  f167d0c:	3c0a800a */ 	lui	$t2,%hi(g_Vars+0x6c)
/*  f167d10:	8d4aa02c */ 	lw	$t2,%lo(g_Vars+0x6c)($t2)
/*  f167d14:	00008825 */ 	or	$s1,$zero,$zero
/*  f167d18:	00008025 */ 	or	$s0,$zero,$zero
/*  f167d1c:	11400003 */ 	beqz	$t2,.L0f167d2c
/*  f167d20:	3c0b800a */ 	lui	$t3,%hi(g_Vars+0x68)
/*  f167d24:	10000002 */ 	beqz	$zero,.L0f167d30
/*  f167d28:	24060001 */ 	addiu	$a2,$zero,0x1
.L0f167d2c:
/*  f167d2c:	00003025 */ 	or	$a2,$zero,$zero
.L0f167d30:
/*  f167d30:	8d6ba028 */ 	lw	$t3,%lo(g_Vars+0x68)($t3)
/*  f167d34:	3c09800a */ 	lui	$t1,%hi(g_Vars+0x64)
/*  f167d38:	3c07800a */ 	lui	$a3,%hi(g_Vars+0x70)
...
.L0f167d4c:
/*  f167d4c:	8d29a024 */ 	lw	$t1,%lo(g_Vars+0x64)($t1)
...
.L0f167d68:
/*  f167d68:	8ce7a030 */ 	lw	$a3,%lo(g_Vars+0x70)($a3)
...
.L0f167e2c:
/*  f167e2c:	3c0f800a */ 	lui	$t7,%hi(g_Vars+0x34)
/*  f167e30:	8def9ff4 */ 	lw	$t7,%lo(g_Vars+0x34)($t7)
...
void func0f167e7c(s32 stagenum)
{
	...
	if (stagenum == STAGE_5A) {
		func0f00b480();
	} else if (stagenum == STAGE_5B) {
		// empty
	} else if (stagenum == STAGE_5C) {
		// empty
	} else if (stagenum == STAGE_5D) {
		// empty
	} else {
		s32 i;
		s32 j;
	...
	if (stagenum == STAGE_5B) {
		func0f10c970();
	}

	if (stagenum == STAGE_5D) {
		func0f10cb2c();
	}
...
/*  f1685e4:	3c078008 */ 	lui	$a3,%hi(g_FadeColor)
/*  f1685e8:	8ce74060 */ 	lw	$a3,%lo(g_FadeColor)($a3)
...
.L0f168650:
/*  f168650:	3c198008 */ 	lui	$t9,%hi(g_FadeNumFrames)
/*  f168654:	87394054 */ 	lh	$t9,%lo(g_FadeNumFrames)($t9)
...
/*  f1686c8:	3c058008 */ 	lui	$a1,%hi(g_FadePrevColor)
/*  f1686cc:	46040202 */ 	mul.s	$f8,$f0,$f4
/*  f1686d0:	8ca5405c */ 	lw	$a1,%lo(g_FadePrevColor)($a1)
...
.late_rodata
glabel var7f1b77e0
.word func0f1688fc+0x168 # f168a64
glabel var7f1b77e4
.word func0f1688fc+0x1cc # f168ac8
glabel var7f1b77e8
.word func0f1688fc+0x78 # f168974
glabel var7f1b77ec
.word func0f1688fc+0x168 # f168a64
glabel var7f1b77f0
.word func0f1688fc+0x1cc # f168ac8
glabel var7f1b77f4
.word func0f1688fc+0x50 # f16894c
glabel var7f1b77f8
.word func0f1688fc+0x1cc # f168ac8
glabel var7f1b77fc
.word func0f1688fc+0x1cc # f168ac8
...
/*  f168954:	3c0a800a */ 	lui	$t2,%hi(g_Vars+0x28c)
/*  f168958:	8d4aa24c */ 	lw	$t2,%lo(g_Vars+0x28c)($t2)
...
/*  f1689b4:	3c0e800a */ 	lui	$t6,%hi(g_Vars+0x284)
...
/*  f1689c8:	8dcea244 */ 	lw	$t6,%lo(g_Vars+0x284)($t6)
...
/*  f169bb4:	3c0a800a */ 	lui	$t2,%hi(var800a19c4)
/*  f169bb8:	5f00001a */ 	bgtzl	$t8,.L0f169c24
/*  f169bbc:	8e700284 */ 	lw	$s0,0x284($s3)
/*  f169bc0:	8d4a19c4 */ 	lw	$t2,%lo(var800a19c4)($t2)
...
/*  f16a168:	24860008 */ 	addiu	$a2,$a0,8
...
/*  f16c53c:	3c068008 */ 	lui	$a2,%hi(var80084028)
/*  f16c540:	8cc64028 */ 	lw	$a2,%lo(var80084028)($a2)
.L0f16c544:
...
/*  f16c560:	3c068008 */ 	lui	$a2,%hi(var80084028)
/*  f16c564:	8cc64028 */ 	lw	$a2,%lo(var80084028)($a2)
.L0f16c568:
...
/*  f16c594:	3c0e8008 */ 	lui	$t6,%hi(var80084028)
/*  f16c598:	8dce4028 */ 	lw	$t6,%lo(var80084028)($t6)
...
.L0f16c750:
/*  f16c750:	8f18402c */ 	lw	$t8,%lo(var8008402c)($t8)
...
/*  f16c77c:	3c048008 */ 	lui	$a0,%hi(var8008402c)
/*  f16c780:	27a2016c */ 	addiu	$v0,$sp,0x16c
/*  f16c784:	01a22821 */ 	addu	$a1,$t5,$v0
/*  f16c788:	8c84402c */ 	lw	$a0,%lo(var8008402c)($a0)
...
.L0f16c7b8:
/*  f16c7b8:	3c188008 */ 	lui	$t8,%hi(var80084030)
/*  f16c7bc:	8f184030 */ 	lw	$t8,%lo(var80084030)($t8)
...
/*  f16c7e8:	3c048008 */ 	lui	$a0,%hi(var80084030)
/*  f16c7ec:	27a20078 */ 	addiu	$v0,$sp,0x78
/*  f16c7f0:	03222821 */ 	addu	$a1,$t9,$v0
/*  f16c7f4:	8c844030 */ 	lw	$a0,%lo(var80084030)($a0)
...
.L0f16c840:
/*  f16c840:	3c198008 */ 	lui	$t9,%hi(g_MpMatchTime)
/*  f16c844:	8f394024 */ 	lw	$t9,%lo(g_MpMatchTime)($t9)
