...
Gfx *fadeRender(Gfx *gdl)
{
	...
	gDPFillRectangle(gdl++,
			viGetLeft(),
			viGetTop() + inset,
			viGetLeft() + viGetWidth() + 1,
			viGetTop() + viGetHeight() - inset + 2);
