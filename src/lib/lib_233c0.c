...
GLOBAL_ASM(
glabel func00028200
/*    28200:	3c0e800a */ 	lui	$t6,%hi(g_Vars+0x32c)
/*    28204:	8dcea2ec */ 	lw	$t6,%lo(g_Vars+0x32c)($t6)
...
/*    28e58:	3c13800a */ 	lui	$s3,%hi(g_TileFileData)
/*    28e5c:	3c12800a */ 	lui	$s2,%hi(g_TileRooms)
/*    28e60:	3c11800a */ 	lui	$s1,%hi(g_TileNumRooms)
/*    28e64:	2631a8a4 */ 	addiu	$s1,$s1,%lo(g_TileNumRooms)
/*    28e68:	2652a8a8 */ 	addiu	$s2,$s2,%lo(g_TileRooms)
/*    28e6c:	2673a8a0 */ 	addiu	$s3,$s3,%lo(g_TileFileData)
...
/*    28f78:	0fc198a4 */ 	jal	propUpdateGeometry
		...
		u8 *floortype, u16 *floorflags, s16 *floorroom, s32 *inlift, struct prop **lift)
{
	...
	if (inlift) {
		if (tile && tile->unk00 == 1 && (tile->flags & TILEFLAG_0020)) {
			*inlift = true;
			*lift = sp72->lift;
...
s32 func0002a9f0(struct coord *origpos, struct coord *dstpos, f32 width, s16 *dstrooms, s32 arg4, s32 arg5, f32 ymax, f32 ymin)
{
	...
	if (sp44) {
		...
		func0002901c(origpos, &dist, width, &sp44);
	}
