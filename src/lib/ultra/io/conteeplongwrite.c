...
/*     6484:	3c15800a */ 	lui	$s5,%hi(__osEepromTimerMsg)
/*     6488:	3c14800a */ 	lui	$s4,%hi(__osEepromTimer)
/*     648c:	3c13800a */ 	lui	$s3,%hi(__osEepromTimerQ)
/*     6490:	2673c848 */ 	addiu	$s3,$s3,%lo(__osEepromTimerQ)
/*     6494:	2694c828 */ 	addiu	$s4,$s4,%lo(__osEepromTimer)
/*     6498:	26b5c860 */ 	addiu	$s5,$s5,%lo(__osEepromTimerMsg)
