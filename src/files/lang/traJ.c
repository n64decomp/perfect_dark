...
char *lang[] = {
	...
	/* 63*/ "Let's see how that over-confident thief deals with our gas defense system. She'll think twice before messing with me again!",
	...
	/* 70*/ "I'm alive. I thought I'd be chopped up like the others by now. You're from the Institute, aren't you? I recognise you from before. You helped me. Thank you.",
	/* 71*/ "You... You speak our language?",
	/* 72*/ "Watch her, she's sharp.",
	/* 73*/ "Earrggghh... eerggh...",
	/* 74*/ "What's wrong?",
	/* 75*/ "I have a headache. And with a head this big, that's no joke.",
	/* 76*/ "Can you walk? We must leave before they get organised and hunt us down.",
