...
u32 props[] = {
	...
	tag(0x06, 8)
	tag(0x07, 8)
	multimonitor(0x0099, MODEL_COMHUB, 0x01f2, OBJFLAG_00000002 | OBJFLAG_INVINCIBLE, 0, OBJFLAG3_INTERACTABLE, 1000, 19, 19, 19, 0)
	multimonitor(0x0099, MODEL_COMHUB, 0x01f3, OBJFLAG_00000002 | OBJFLAG_INVINCIBLE, 0, OBJFLAG3_INTERACTABLE, 1000, 19, 19, 19, 0)
	multimonitor(0x0099, MODEL_COMHUB, 0x01f4, OBJFLAG_00000002 | OBJFLAG_INVINCIBLE, 0, OBJFLAG3_INTERACTABLE, 1000, 19, 19, 19, 0)
	multimonitor(0x0099, MODEL_COMHUB, 0x01f5, OBJFLAG_00000002 | OBJFLAG_INVINCIBLE, 0, OBJFLAG3_INTERACTABLE, 1000, 19, 19, 19, 0)
	multimonitor(0x0099, MODEL_COMHUB, 0x01f6, OBJFLAG_00000002 | OBJFLAG_INVINCIBLE, 0, OBJFLAG3_INTERACTABLE, 1000, 19, 19, 19, 0)
	multimonitor(0x0099, MODEL_COMHUB, 0x01f7, OBJFLAG_00000002 | OBJFLAG_INVINCIBLE, 0, OBJFLAG3_INTERACTABLE, 1000, 19, 19, 19, 0)
	multimonitor(0x0099, MODEL_COMHUB, 0x01f8, OBJFLAG_00000002 | OBJFLAG_INVINCIBLE, 0, OBJFLAG3_INTERACTABLE, 1000, 19, 19, 19, 0)
	multimonitor(0x0099, MODEL_COMHUB, 0x01f9, OBJFLAG_00000002 | OBJFLAG_INVINCIBLE, 0, OBJFLAG3_INTERACTABLE, 1000, 19, 19, 19, 0)
	tag(0x08, 1)
	tag(0x09, 1)
	tag(0x0a, 1)
	tag(0x0b, 1)
	...
	tag(0x0f, 1)
	tag(0x13, 1)
	multimonitor(0x0099, MODEL_COMHUB, 0x01fa, OBJFLAG_00000002 | OBJFLAG_00000020 | OBJFLAG_00000040 | OBJFLAG_00000080, OBJFLAG2_00000001, OBJFLAG3_INTERACTABLE, 1000, 19, 19, 19, 0)
	tag(0x14, 1)
	...
	tag(0x24, 5)
	tag(0x25, 5)
	singlemonitor(0x0100, MODEL_MODEMBOX, 0x01fb, OBJFLAG_00000002 | OBJFLAG_DEACTIVATED, OBJFLAG2_IMMUNETOGUNFIRE | OBJFLAG2_00200000, OBJFLAG3_INTERACTABLE | OBJFLAG3_INTERACTSHORTRANGE, 1000, 20)
	singlemonitor(0x0100, MODEL_MODEMBOX, 0x01fc, OBJFLAG_00000002 | OBJFLAG_DEACTIVATED, OBJFLAG2_IMMUNETOGUNFIRE | OBJFLAG2_00200000, OBJFLAG3_INTERACTABLE | OBJFLAG3_INTERACTSHORTRANGE, 1000, 20)
	singlemonitor(0x0100, MODEL_MODEMBOX, 0x01fd, OBJFLAG_00000002 | OBJFLAG_DEACTIVATED, OBJFLAG2_IMMUNETOGUNFIRE | OBJFLAG2_00200000, OBJFLAG3_INTERACTABLE | OBJFLAG3_INTERACTSHORTRANGE, 1000, 20)
	singlemonitor(0x0100, MODEL_MODEMBOX, 0x01fe, OBJFLAG_00000002 | OBJFLAG_DEACTIVATED, OBJFLAG2_IMMUNETOGUNFIRE | OBJFLAG2_00200000, OBJFLAG3_INTERACTABLE | OBJFLAG3_INTERACTSHORTRANGE, 1000, 20)
	singlemonitor(0x0100, MODEL_MODEMBOX, 0x01ff, OBJFLAG_00000002 | OBJFLAG_DEACTIVATED, OBJFLAG2_IMMUNETOGUNFIRE | OBJFLAG2_00200000, OBJFLAG3_INTERACTABLE | OBJFLAG3_INTERACTSHORTRANGE, 1000, 20)
	tag(0x17, 1)
#if VERSION >= VERSION_PAL_FINAL
	singlemonitor(0x0100, MODEL_MODEMBOX, 0x0200, OBJFLAG_00000002 | OBJFLAG_DEACTIVATED, OBJFLAG2_00000001, OBJFLAG3_INTERACTABLE, 1000, 3)
#else
	singlemonitor(0x0100, MODEL_MODEMBOX, 0x0200, OBJFLAG_00000002 | OBJFLAG_DEACTIVATED, 0, OBJFLAG3_INTERACTABLE, 1000, 3)
#endif
	tag(0x1a, 1)
#if VERSION >= VERSION_PAL_FINAL
	singlemonitor(0x0100, MODEL_MODEMBOX, 0x0201, OBJFLAG_00000002 | OBJFLAG_DEACTIVATED, OBJFLAG2_00000001, OBJFLAG3_INTERACTABLE, 1000, 3)
#else
	singlemonitor(0x0100, MODEL_MODEMBOX, 0x0201, OBJFLAG_00000002 | OBJFLAG_DEACTIVATED, 0, OBJFLAG3_INTERACTABLE, 1000, 3)
#endif
