...
u32 props[] = {
	...
	tag(0x06, 1)
	stdobject(0x0100, MODEL_CHRBRIEFCASE, PAD_CAVE_00C4, OBJFLAG_00000001 | OBJFLAG_00000020 | OBJFLAG_00000040 | OBJFLAG_00000080 | OBJFLAG_ILLUMINATED | OBJFLAG_INVINCIBLE | OBJFLAG_00400000 | OBJFLAG_01000000, OBJFLAG2_REMOVEWHENDESTROYED | OBJFLAG2_IMMUNETOGUNFIRE | OBJFLAG2_INVISIBLE, 0, 1000)
	tag(0x42, 6)
	tag(0x43, 6)
	tag(0x48, 6)
	tag(0x49, 6)
	...
	tag(0x2b, 1)
	weapon(0x0100, MODEL_CHRREMOTEMINE, PAD_CAVE_0111, OBJFLAG_00000008 | OBJFLAG_00000020 | OBJFLAG_00000040 | OBJFLAG_00000080 | OBJFLAG_ILLUMINATED | OBJFLAG_UNCOLLECTABLE | OBJFLAG_REACTIFSHOT, OBJFLAG2_00000001 | OBJFLAG2_REMOVEWHENDESTROYED | OBJFLAG2_00020000 | OBJFLAG2_INVISIBLE, 0, WEAPON_REMOTEMINE)
	tag(0x2e, 1)
