...
u32 props[] = {
	...
	lift_door(-1, -2, 0)
#if VERSION >= VERSION_PAL_FINAL
	door(0x0100, MODEL_DOOR_ROLLERTRAIN, 0x0322, OBJFLAG_DEACTIVATED, OBJFLAG2_00000800 | OBJFLAG2_AICANNOTUSE, 0, 1000, 0x0000f333, 0x0000c000, 0x000031c7, 0x000031c7, 0x000002fc, DOORFLAG_0004, DOORTYPE_VERTICAL, 0x00000002, 0x0000012c, 0x00000000, 0x00000000, 0x00001900)
#else
	door(0x0100, MODEL_DOOR_ROLLERTRAIN, 0x0322, OBJFLAG_DEACTIVATED, OBJFLAG2_00000800, 0, 1000, 0x0000f333, 0x0000c000, 0x000031c7, 0x000031c7, 0x000002fc, DOORFLAG_0004, DOORTYPE_VERTICAL, 0x00000002, 0x0000012c, 0x00000000, 0x00000000, 0x00001900)
#endif
	lift_door(-1, -4, 1)
	tag(0x39, -2)
	tag(0x3e, 5)
	...
	lift_door(-1, -2, 0)
	door(0x0100, MODEL_DOOR_ROLLERTRAIN, 0x0328, OBJFLAG_DEACTIVATED, OBJFLAG2_00000800, 0, 1000, 0x0000f333, 0x0000c000, 0x000031c7, 0x000031c7, 0x000002fc, DOORFLAG_0004, DOORTYPE_VERTICAL, 0x00000002, 0x0000012c, 0x00000000, 0x00000000, 0x00001900)
	lift_door(-1, -4, 1)
	tag(0x38, -2)
	...
	tag(0x05, 1)
	singlemonitor(0x0100, MODEL_MODEMBOX, 0x0409, OBJFLAG_00000002 | OBJFLAG_DEACTIVATED, OBJFLAG2_00000800, OBJFLAG3_00010000, 1000, 18)
	tag(0x08, 1)
	...
	rename_object(-1, WEAPON_EXPLOSIVES, L_LUE_048, L_LUE_049, L_LUE_050, L_LUE_051, L_LUE_052) // "Obtain explosive."
	tag(0x09, 1)
	singlemonitor(0x0100, MODEL_MODEMBOX, 0x0406, OBJFLAG_00000002 | OBJFLAG_DEACTIVATED, OBJFLAG2_00000001 | OBJFLAG2_00002000, OBJFLAG3_00010000, 1000, 19)
	tag(0x0b, 1)
	singlemonitor(0x0100, MODEL_MODEMBOX, 0x0407, OBJFLAG_00000002 | OBJFLAG_DEACTIVATED, OBJFLAG2_00000001, OBJFLAG3_00010000, 1000, 3)
	tag(0x0c, 1)
	singlemonitor(0x0100, MODEL_MODEMBOX, 0x0408, OBJFLAG_00000002 | OBJFLAG_DEACTIVATED, OBJFLAG2_00000001, OBJFLAG3_00010000, 1000, 3)
	tag(0x10, 1)
	multimonitor(0x0099, MODEL_PD_CONSOLE, 0x04f7, OBJFLAG_00000001 | OBJFLAG_00000020 | OBJFLAG_00000080 | OBJFLAG_00000100 | OBJFLAG_INVINCIBLE, OBJFLAG2_00000800, OBJFLAG3_00010000, 1000, 3, 3, 0, 0)
	tag(0x54, 1)
	...
	singlemonitor(0x0100, MODEL_MODEMBOX, 0x040b, OBJFLAG_00000002 | OBJFLAG_DEACTIVATED, OBJFLAG2_00000800, 0, 1000, 18)
