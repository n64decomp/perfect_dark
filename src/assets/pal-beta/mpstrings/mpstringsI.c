...
static struct mpstrings strings[] = {
	...
	{
		"Prendi il controllo del colle contro replicanti base.Puoi usare la tecnologia scudo e il K7 Vendetta. ",
		{
			"RepCI:1\n",
			"RepCI:2\n",
			"RepCI:3\n",
	...
	{
		"Lotta per controllo del colle contro una squadra di replicanti esperti nel magazzino. Le armi uccidono al primo colpo.",
		{
			"RepJoanna:1\n",
			"RepJoanna:2\n",
			"RepJoanna:3\n",
	...
	{
		"Diventa Re del Colle contro replicanti esperti! Armi: pistola a rotazione e sedativo.",
		{
			"RepBlonde:1\n",
			"RepBlonde:2\n",
			"RepBlonde:3\n",
	...
	{
		"Combattimento standard con minedi prossimità.Nessun radar disponibile.",
		{
			"RepBio:1\n",
			"RepBio:2\n",
			"RepBio:3\n",
	...
	{
		"Combattimento accelerato contro una squadra di replicanti esperti. Armi: lanciamissili e Televista.",
		{
			"RepCassan\n",
			"RepTrent\n",
			"RepCecchi:1\n",
	...
	{
		"Sfida ad un-colpo-e-sei- -morto con una modifica: difendi il replicante più debole della tua squadra. Armi: pistole e scudi.",
		{
			"RepPilota:1\n",
			"RepPilota:2\n",
			"RepAereo:6\n",
	...
	{
		"Sfida difendi-la-cartella ad un-colpo-e-sei-morto. Tra le armi la balestra e il fucile da cecchino.",
		{
			"RepPresid\n",
			"RepGuard:1\n",
			"RepGuard:2\n",
	...
	{
		"Conquista la cassa contro una squadra di replicanti esperti.Armi: Gold DY357 Magnum e sedativo. ",
		{
			"RepGuard:1\n",
			"RepSoldat:1\n",
			"RepAereo:1\n",
