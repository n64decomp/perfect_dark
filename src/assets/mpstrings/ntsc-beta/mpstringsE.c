...
static struct mpstrings strings[] = {
	...
	{
		"Capture the enemy's case while defending your own. Killing the case carrier means the case returns to the base.",
		{
			"SnipeSim:1\n",
			"SnipeSim:2\n",
			"SnipeSim:3\n",
	...
	{
		"A one-hit-kill scenario against expert simulants. Weapons include the FarSight and the laptop gun.",
		{
			"TrentSim\n",
			"NSASim:1\n",
			"NSASim:2\n",
	...
	{
		"Fight against a team of simulants to hack the terminal using the Data Uplink.",
		{
			"GuardSim:1\n",
			"SWATSim:1\n",
			"GuardSim:2\n",
	...
	{
		"King of the hill  against expert simulants. Weapons include the shotgun and tranquilizer.",
		{
			"BlondeSim:1\n",
			"BlondeSim:2\n",
			"BlondeSim:3\n",
	...
	{
		"One-hit kills, G5, with tranquilizers.",
		{
			"CIASim:1\n",
			"FBISim:1\n",
			"CIASim:2\n",
	...
	{
		"Capture the case in Area 52 with cloaking.",
		{
			"GuardSim:1\n",
			"TroopSim:1\n",
			"GuardSim:2\n",
	...
	{
		"Hold the briefcase in the Grid with devastators.",
		{
			"LabSim:1\n",
			"LabSim:2\n",
			"LabSim:3\n",
	...
	{
		"Standard combat. Weapons include proximity mines. There is no radar on this challenge.",
		{
			"BioSim:1\n",
			"BioSim:2\n",
			"BioSim:3\n",
	...
	{
		"A king of the hill game. Weapons include fly-by-wire missiles.",
		{
			"DanSim\n",
			"CISim:1\n",
			"CISim:2\n",
	...
	{
		"Fast movement combat against expert simulants. Weapons include the rocket launcher and the FarSight.",
		{
			"CassSim\n",
			"TrentSim\n",
			"SnipeSim:1\n",
	...
	{
		"Hack into the terminal using the Data Uplink.The Cloaking Device is available.",
		{
			"JoSim\n",
			"SnowSim:1\n",
			"SnowSim:2\n",
	...
	{
		"A hold the briefcase game with one-hit kills. Weapons include the crossbow and the sniper rifle.",
		{
			"PresSim\n",
			"GuardSim:1\n",
			"GuardSim:2\n",
	...
	{
		"Combat in slow motion. Weapons include the RCP120.",
		{
			"CloneSim\n",
			"StripeSim:1\n",
			"StripeSim:2\n",
	...
	{
		"Capture the case game against a team of expert simulants. Weapons include the Gold DY357 Magnum and the tranquilizer.",
		{
			"GuardSim:1\n",
			"TroopSim:1\n",
			"AirSim:1\n",
	...
	{
		"A hacker central game featuring rocket launchers and expert opponents.",
		{
			"CIASim:1\n",
			"FBISim:1\n",
			"CIASim:2\n",
	...
	{
		"A capture the case game with no shields and expert opponents.",
		{
			"GuardSim:1\n",
			"GuardSim:2\n",
			"GuardSim:3\n",
	...
	{
		"Standard combat with no shields available. Weapons include the DY357 and the Dragon.",
		{
			"WorkSim:1\n",
			"WorkSim:2\n",
			"GuardSim:1\n",
