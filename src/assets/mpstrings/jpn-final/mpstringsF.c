...
static struct mpstrings strings[] = {
	...
	{
		"Prenez le contrôle de la zone contre des simulants de base. Boucliers et K7 Avenger disponibles",
		{
			"CISim:1\n",
			"CISim:2\n",
			"CISim:3\n",
	...
	{
		"Affrontez une équipe de simulants standards dans le complexe en  utilisant le fusil FarSight.",
		{
			"CassSim\n",
			"GardSim:1\n",
			"GardSim:2\n",
	...
	{
		"Gardez la mallette aussi longtemps que possible en affrontant une grande équipe de simulants de base.",
		{
			"WorkSim:1\n",
			"WorkSim:2\n",
			"WorkSim:3\n",
	...
	{
		"Prenez le contrôle de la zone contre une équipe de simulants de base dans l'entrepôt. Armes meurtrières.",
		{
			"JoSim:1\n",
			"JoSim:2\n",
			"JoSim:3\n",
	...
	{
		"Capturez la mallette ennemie tout en protégeant la vôtre. Tuer le porteur ramène la mallette à la base.",
		{
			"SnipeSim:1\n",
			"SnipeSim:2\n",
			"SnipeSim:3\n",
	...
	{
		"Affrontez une équipe de simulants pour le contrôle des PC. Connectez un PC pour gagner un point.",
		{
			"GardSim:1\n",
			"SWATSim:1\n",
			"GardSim:2\n",
	...
	{
		"Une partie Roi de la Zone. Les missiles radioguidés sont disponibles.",
		{
			"DanSim\n",
			"ICSim:1\n",
			"ICSim:2\n",
	...
	{
		"Contrôlez les PC pour les donner à votre équipe. L'occulteur est disponible.",
		{
			"JoSim\n",
			"SnowSim:1\n",
			"SnowSim:2\n",
	...
	{
		"Une partie Gardez la Mallette avec tirs meurtriers. Armes incluant arbalète et fusil sniper.",
		{
			"PresSim\n",
			"GardSim:1\n",
			"GardSim:2\n",
	...
	{
		"Une partie Contrôle des PC contre des simulants experts. Lance-roquettes disponible.",
		{
			"CIASim:1\n",
			"FBISim:1\n",
			"CIASim:2\n",
	...
	{
		"Une partie Roi de la Zone avec des pistolets. Les simulants sont de niveau élite.",
		{
			"BlondeSim:1\n",
			"CassSim\n",
			"TrentSim\n",
