...
static struct mpstrings strings[] = {
	...
	{
		"Basis-Simulanten mit Sturmgewehren und Zeitzünder-Minen sind mit dabei!",
		{
			"TechSim:1\n",
			"TechSim:2\n",
			"TechSim:3\n",
	...
	{
		"Verteidigen Sie den Hügel gegen ein Team von Standard-Simulanten.",
		{
			"CISim:1\n",
			"CISim:2\n",
			"CISim:3\n",
	...
	{
		"Kämpfen Sie gegen Standard-Simulanten unter Verwendung einer Fernsicht-Waffe.",
		{
			"CassSim\n",
			"WachSim:1\n",
			"WachSim:2\n",
	...
	{
		"Verteidigen Sie den Aktenkoffer so lange wie möglich gegen Basis-Simulanten.",
		{
			"WorkSim:1\n",
			"WorkSim:2\n",
			"WorkSim:3\n",
	...
	{
		"Bringen Sie den Hügel unter Ihre Kontrolle. Ein Treffer bedeutet das Aus.",
		{
			"JoSim:1\n",
			"JoSim:2\n",
			"JoSim:3\n",
	...
	{
		"Schnappen Sie den Koffer der Gegner, während Sie Ihren eigenen verteidigen.",
		{
			"SnipeSim:1\n",
			"SnipeSim:2\n",
			"SnipeSim:3\n",
	...
	{
		"In diesem Szenario dürfen Sie nicht getroffen werden. Seien Sie vorsichtig!",
		{
			"TrentSim\n",
			"NSASim:1\n",
			"NSASim:2\n",
	...
	{
		"Kämpfen Sie gegen ein Team von Experten-Simulanten. Hacken Sie in den PC.",
		{
			"WachSim:1\n",
			"SWATSim:1\n",
			"WachSim:2\n",
	...
	{
		"Verteidigen sie den Hügel. Als Waffen stehen Schrotflinten und Betäubungs-Gewehre zur Verfügung.",
		{
			"BlondSim:1\n",
			"BlondSim:2\n",
			"BlondSim:3\n",
	...
	{
		"Der Herr des Hügels. Unter den Waffen finden Sie auch Fly-by-wire-Raketen.",
		{
			"DanSim\n",
			"CISim:1\n",
			"CISim:2\n",
	...
	{
		"Lassen Sie sich nicht treffen und schützen Sie schwächere Mitstreiter. Pistolen und Schilde sind vorhanden.",
		{
			"PilotSim:1\n",
			"PilotSim:2\n",
			"LuftSim:6\n",
	...
	{
		"Hacken Sie sich in den PC! Die Tarnkappen-Technik ist verfügbar.",
		{
			"JoSim\n",
			"SchneeSim:1\n",
			"SchneeSim:2\n",
	...
	{
		"Schnappen Sie den Koffer vor den Experten-Simulanten. Waffen: Gold DY357 Magnum, Betäubungs-Gewehr. ",
		{
			"WachSim:1\n",
			"TruppSim:1\n",
			"LuftSim:1\n",
