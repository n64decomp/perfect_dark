...
u32 props[] = {
	...
	tag(0x09, 1)
	multimonitor(0x00cc, MODEL_SK_CONSOLE2, PAD_LEE_01F1, OBJFLAG_FALL | OBJFLAG_CORE_GEO_INUSE, OBJFLAG2_IMMUNETOANTI, OBJFLAG3_INTERACTABLE, 1000, 21, 20, 20, 0)
	multimonitor(0x00cc, MODEL_SK_CONSOLE2, PAD_LEE_01F2, OBJFLAG_FALL | OBJFLAG_CORE_GEO_INUSE, OBJFLAG2_IMMUNETOANTI, 0, 1000, 21, 20, 20, 0)
	weapon(0x0100, MODEL_CHRSKROCKET, PAD_LEE_01D2, 0, 0, 0, WEAPON_SLAYER)
	tag(0x04, 3)
	tag(0x05, 3)
	tag(0x06, 3)
	multimonitor(0x00cc, MODEL_SK_CONSOLE2, PAD_LEE_01F0, OBJFLAG_FALL | OBJFLAG_CORE_GEO_INUSE, OBJFLAG2_IMMUNETOANTI, 0, 1000, 21, 20, 20, 0)
	multimonitor(0x00cc, MODEL_SK_CONSOLE2, PAD_LEE_01EF, OBJFLAG_FALL | OBJFLAG_CORE_GEO_INUSE, OBJFLAG2_IMMUNETOANTI, 0, 1000, 21, 20, 20, 0)
	multimonitor(0x00cc, MODEL_SK_CONSOLE2, PAD_LEE_01EE, OBJFLAG_FALL | OBJFLAG_CORE_GEO_INUSE, OBJFLAG2_IMMUNETOANTI, 0, 1000, 21, 20, 20, 0)
