...
u8 func0429_grimshaw_disguise[] = {
	...
	label(0x06)
	speak(CHR_BOND, L_DISH_043, MP3(FILE_ATRJO01M), CHANNEL_6, COLOR_09_BLUE) // "I'm here to pick up the equipment."
	...
	if_chr_has_hiddenflag(CHR_BOND, CHRHFLAG_DISGUISED, /*goto*/ 0x2f)
	do_preset_animation(PRESETANIM_TALKRANDOM)
	speak(CHR_TARGET, L_DISH_044, MP3(FILE_ATRGRIM01M), CHANNEL_6, COLOR_05_GREEN) // "Go away, Joanna. You're not fooling anybody!"
	...
	label(0x2f)
	do_preset_animation(PRESETANIM_TALKRANDOM)
	speak(CHR_TARGET, L_DISH_045, MP3(FILE_ATRGRIM02M), CHANNEL_6, COLOR_05_GREEN) // "Here you go. Don't drop it now."
...
u8 func100c_cloak_detection[] = {
	...
	speak(CHR_TARGET, L_DISH_048, MP3(FILE_ATRCARR06M), CHANNEL_6, COLOR_05_GREEN) // "You'll have to do better than that, Joanna."
...
u8 func042a_carrington_cloak[] = {
	...
	label(0x06)
	do_preset_animation(PRESETANIM_TALKRANDOM)
	speak(CHR_BOND, L_DISH_049, MP3(FILE_ATRCARR07M), CHANNEL_6, COLOR_06_WHITE) // "Joanna, where did you spring from?"
	...
	label(0x06)
	do_preset_animation(PRESETANIM_TALKRANDOM)
	speak(CHR_TARGET, L_DISH_053, MP3(FILE_ATRCARR08M), CHANNEL_6, COLOR_06_WHITE) // "I think we can safely say your training is now complete!"
...
u8 func042c_carrington_tour[] = {
	...
	do_preset_animation(PRESETANIM_TALKRANDOM)
	remove_hudmsgs
	speak(CHR_TARGET, L_DISH_066, SFXMAP_8029, CHANNEL_6, COLOR_06_WHITE) // "Joanna, it's good to see you."
	restart_timer
	...
	label(0x06)
	do_preset_animation(PRESETANIM_TALKRANDOM)
	speak(CHR_TARGET, L_DISH_067, MP3(FILE_ATRCARR01M), CHANNEL_6, COLOR_06_WHITE) // "Come with me. I'll walk you round the training rooms."
	restart_timer
	...
	do_preset_animation(PRESETANIM_TALKRANDOM)
	remove_hudmsgs
	speak(CHR_TARGET, L_DISH_068, MP3(FILE_ATRCARR04M), CHANNEL_6, COLOR_06_WHITE) // "The information center is through this door."
	restart_timer
	...
	label(0x06)
	do_preset_animation(PRESETANIM_TALKRANDOM)
	play_sound(SFXMAP_802A, CHANNEL_6)
...
#endif
	do_preset_animation(PRESETANIM_TALKRANDOM)
	speak(CHR_TARGET, L_DISH_069, MP3(FILE_ATRCARR03M), CHANNEL_6, COLOR_06_WHITE) // "In here we have the device lab."
	restart_timer
	...
	label(0x06)
	do_preset_animation(PRESETANIM_TALKRANDOM)
	play_sound(SFXMAP_8028_CARR_HELLO_JOANNA, CHANNEL_6)
	...
	label(0x2f)
	do_preset_animation(PRESETANIM_TALKRANDOM)
	speak(CHR_TARGET, L_DISH_070, MP3(FILE_ATRCARR05M), CHANNEL_6, COLOR_06_WHITE) // "This leads to the simulant training room."
	restart_timer
	...
	label(0x2f)
	do_preset_animation(PRESETANIM_TALKRANDOM)
	speak(CHR_TARGET, L_DISH_071, MP3(FILE_ATRCARR02M), CHANNEL_6, COLOR_06_WHITE) // "This is the firing range, Jo."
	restart_timer
	...
	label(0x2f)
	do_preset_animation(PRESETANIM_TALKRANDOM)
	speak(CHR_TARGET, L_DISH_072, MP3(FILE_ATRCARR12M), CHANNEL_6, COLOR_06_WHITE) // "This corridor leads down to the hangar."
	restart_timer
	...
	label(0x2f)
	do_preset_animation(PRESETANIM_TALKRANDOM)
	speak(CHR_TARGET, L_DISH_124, MP3(FILE_ACARRBYE02M), CHANNEL_6, COLOR_06_WHITE) // "Okay, Jo, I'll leave you to prepare for the mission."
...
u8 func042d_unused[] = {
	...
	label(0x06)
	assign_sound(SFXMAP_802D_GRIMSHAW_HI_THERE, CHANNEL_6)
...
u8 func042e_devicegirl_reply_to_carrington[] = {
	...
	yield
	yield
	assign_sound(MP3(FILE_ACIFARR12M), CHANNEL_6)
	bind_channel_to_entity(CHANNEL_6, CHR_SELF, 0x0bb8, 0x1770, 0x01)
...
#define holo1_code_thing_p2(object1, object2, hint, msg) \
 ...
 \
	...
	assign_sound(SFXMAP_81B0_DOOR, CHANNEL_7) \
...
u8 func1000_jo_typing[] = {
	...
	label(0x06)
	play_sound(SFXMAP_8116, CHANNEL_5)
	...
	label(0x06)
	play_sound(SFXMAP_8118_TYPING, CHANNEL_6)
