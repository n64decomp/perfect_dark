...
u32 props[] = {
	...
	beginobjective(1, L_DEPO_010, (DIFFBIT_SA | DIFFBIT_PA | DIFFBIT_PD)) // "Deactivate laser grid systems"
		complete_flags(STAGEFLAG_ALL_LASERS_DISABLED | STAGEFLAG_LASERSET1_DISABLED | STAGEFLAG_LASERSET2_DISABLED | STAGEFLAG_LASERSET3_DISABLED | STAGEFLAG_LASERSET4_DISABLED)
		fail_flags(STAGEFLAG_LASERSWITCH1_DESTROYED | STAGEFLAG_LASERSWITCH2_DESTROYED | STAGEFLAG_LASERSWITCH3_DESTROYED | STAGEFLAG_LASERSWITCH4_DESTROYED)
	endobjective
	...
	beginobjective(2, L_DEPO_011, (DIFFBIT_A | DIFFBIT_SA | DIFFBIT_PA | DIFFBIT_PD)) // "Holograph meeting conspirators"
		...
		fail_flags(STAGEFLAG_20000000 | STAGEFLAG_CONSPIRATORS_ALERTED | STAGEFLAG_00002000)
	endobjective
