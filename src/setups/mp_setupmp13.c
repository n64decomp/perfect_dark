...
u32 props[] = {
	weapon(0x0100, 0x0000, PAD_MP13_00BD, OBJFLAG_00000001, 0, 0, WEAPON_MPLOCATION00)
	...
	weapon(0x0100, 0x0000, PAD_MP13_00BE, OBJFLAG_00000001, 0, 0, WEAPON_MPLOCATION01)
	...
	weapon(0x0100, 0x0000, PAD_MP13_00BF, OBJFLAG_00000001, 0, 0, WEAPON_MPLOCATION02)
	...
	weapon(0x0100, 0x0000, PAD_MP13_00C0, OBJFLAG_00000001, 0, 0, WEAPON_MPLOCATION03)
	...
	weapon(0x0100, 0x0000, PAD_MP13_00C1, OBJFLAG_00000001, 0, 0, WEAPON_MPLOCATION04)
	...
	weapon(0x0100, 0x0000, PAD_MP13_00C2, OBJFLAG_00000001, 0, 0, WEAPON_MPLOCATION05)
	...
	weapon(0x0100, 0x0000, PAD_MP13_00C3, OBJFLAG_00000001, 0, 0, WEAPON_MPLOCATION06)
	...
	weapon(0x0100, 0x0000, PAD_MP13_00C4, OBJFLAG_00000001, 0, 0, WEAPON_MPLOCATION07)
	...
	weapon(0x0100, 0x0000, PAD_MP13_00C5, OBJFLAG_00000001, 0, 0, WEAPON_MPLOCATION08)
	...
	weapon(0x0100, 0x0000, PAD_MP13_00C6, OBJFLAG_00000001, 0, 0, WEAPON_MPLOCATION09)
