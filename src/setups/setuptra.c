...
u8 func0403_init_jonathan[] = {
	...
	// Agent only
	beginloop(0x0d)
		chr_move_to_pad(CHR_JONATHAN, PAD_TRA_0398, 0x00, /*goto*/ 0x32)
	endloop(0x0d)
...
u8 func1008_spawngroup1[] = {
	...
	beginloop(0x5f)
		...
		try_spawn_chr_at_pad(BODY_AREA51GUARD, HEAD_RANDOM, PAD_TRA_00C7, AILIST_SPAWNGROUP1_GUARD, SPAWNFLAG_00000200, /*goto*/ 0x60)
		reloop(0x5f)
...
u8 func1013_spawngroup2[] = {
	...
	beginloop(0x5f)
		...
		try_spawn_chr_at_pad(BODY_AREA51GUARD, HEAD_RANDOM, PAD_TRA_0144, AILIST_SPAWNGROUP2_GUARD, SPAWNFLAG_00000200, /*goto*/ 0x60)
		goto_next(0x06)

		label(0x32)
		try_spawn_chr_at_pad(BODY_AREA51GUARD, HEAD_RANDOM, PAD_TRA_0138, AILIST_SPAWNGROUP2_GUARD, SPAWNFLAG_00000200, /*goto*/ 0x60)
		goto_next(0x06)
...
u8 func1014_spawngroup3[] = {
	...
	beginloop(0x5f)
		...
		try_spawn_chr_at_pad(BODY_AREA51GUARD, HEAD_RANDOM, PAD_TRA_0117, AILIST_SPAWNGROUP3_GUARD, SPAWNFLAG_00000200, /*goto*/ 0x60)
		goto_next(0x06)

		// Spawn in mine room
		label(0x32)
		try_spawn_chr_at_pad(BODY_AREA51GUARD, HEAD_RANDOM, PAD_TRA_013E, AILIST_SPAWNGROUP3_GUARD, SPAWNFLAG_00000200, /*goto*/ 0x60)
		goto_next(0x06)
...
u8 func1015_spawngroup4[] = {
	...
	beginloop(0x5f)
		...
		// never pass.
		try_spawn_chr_at_pad(BODY_AREA51GUARD, HEAD_RANDOM, PAD_TRA_0140, AILIST_SPAWNGROUP3_GUARD, SPAWNFLAG_00000200, /*goto*/ 0x60)
		goto_next(0x06)
...
u8 func0c01_midcutscene[] = {
	...
	if_chr_death_animation_finished(CHR_COOP, /*goto*/ 0x32)
	chr_move_to_pad(CHR_COOP, PAD_TRA_0156, 0x01, /*goto*/ 0x32)
	label(0x32)
...
u8 func040f_warp_jon_to_catwalk[] = {
	...
	stop_chr
	yield
	chr_move_to_pad(CHR_JONATHAN, PAD_TRA_0152, 0x00, /*goto*/ 0x32)
	label(0x32)
	yield
