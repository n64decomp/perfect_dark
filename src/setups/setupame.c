...
u32 props[] = {
	...
	tag(0x10, 1)
	multimonitor(0x0099, MODEL_PD_CONSOLE, PAD_AME_0258, OBJFLAG_FALL | OBJFLAG_XTOPADBOUNDS | OBJFLAG_ZTOPADBOUNDS | OBJFLAG_CORE_GEO_INUSE, 0, 0, 1000, 8, 3, 0, 0)
	tag(0x11, 1)
	multimonitor(0x0099, MODEL_PD_CONSOLE, PAD_AME_0259, OBJFLAG_FALL | OBJFLAG_XTOPADBOUNDS | OBJFLAG_ZTOPADBOUNDS | OBJFLAG_CORE_GEO_INUSE, 0, 0, 1000, 3, 34, 0, 0)
	tag(0x12, 1)
	multimonitor(0x0099, MODEL_PD_CONSOLE, PAD_AME_025A, OBJFLAG_FALL | OBJFLAG_XTOPADBOUNDS | OBJFLAG_ZTOPADBOUNDS | OBJFLAG_CORE_GEO_INUSE, 0, 0, 1000, 35, 3, 0, 0)
	tag(0x13, 1)
	multimonitor(0x0099, MODEL_PD_CONSOLE, PAD_AME_025B, OBJFLAG_FALL | OBJFLAG_XTOPADBOUNDS | OBJFLAG_ZTOPADBOUNDS | OBJFLAG_CORE_GEO_INUSE, 0, 0, 1000, 3, 33, 0, 0)
	tag(0x19, 2)
	tag(0x1a, 2)
