...
struct prop *chrSpawnAtCoord(s32 body, s32 head, struct coord *pos, s16 *room, f32 angle, u32 spawnflags);
...
struct prop *chrSpawnAtPad(struct chrdata *chr, s32 body, s32 head, s32 pad, u32 spawnflags);
