...
void obj_get_vertices_from_bbox(struct modelrodata_bbox *bbox, f32 realrot[3][3], struct coord *pos, struct coord *vertices);
void obj_get_vertices_from_georodata(struct modelrodata_geo *georodata, f32 realrot[3][3], struct coord *pos, struct coord *vertices);
