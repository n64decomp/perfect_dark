...
void scenarioBriefcaseCallback14(struct chrdata *chr);
u32 scenarioBriefcaseCallback18(void);
u32 scenarioBriefcaseCallback1c(void);
s32 scenarioBriefcaseCallback20(s32 value);
...
s32 scenarioCaptureCallback20(s32 value);
...
s32 scenarioHillCallback20(s32 value);
...
void scenarioHackerCallback14(struct chrdata *chr);
