...
void playerMoveCameraFromPosRooms(struct coord *pos, struct coord *up, struct coord *look, struct coord *pos2, RoomNum *rooms);
void playerMoveCameraFromPosRoom(struct coord *pos, struct coord *up, struct coord *look, struct coord *memcampos, s32 memcamroom);
...
void playerPrepareMoveCameraToPad(s16 pad_id);
