...
#define L_ARK(index)       TEXT(3, index)
#define L_ASH(index)       TEXT(4, index)
#define L_AZT(index)       TEXT(5, index)
#define L_CAT(index)       TEXT(6, index)
#define L_CAVE(index)      TEXT(7, index)
#define L_AREC(index)      TEXT(8, index)
#define L_CRAD(index)      TEXT(9, index)
#define L_CRYP(index)      TEXT(10, index)
#define L_DAM(index)       TEXT(11, index)
#define L_DEPO(index)      TEXT(12, index)
#define L_DEST(index)      TEXT(13, index)
#define L_DISH(index)      TEXT(14, index)
#define L_EAR(index)       TEXT(15, index)
#define L_ELD(index)       TEXT(16, index)
#define L_IMP(index)       TEXT(17, index)
#define L_JUN(index)       TEXT(18, index)
#define L_LEE(index)       TEXT(19, index)
#define L_LEN(index)       TEXT(20, index)
#define L_LIP(index)       TEXT(21, index)
#define L_LUE(index)       TEXT(22, index)
#define L_OAT(index)       TEXT(23, index)
#define L_PAM(index)       TEXT(24, index)
#define L_PETE(index)      TEXT(25, index)
#define L_REF(index)       TEXT(26, index)
#define L_RIT(index)       TEXT(27, index)
#define L_RUN(index)       TEXT(28, index)
#define L_SEVB(index)      TEXT(29, index)
#define L_SEV(index)       TEXT(30, index)
#define L_SEVX(index)      TEXT(31, index)
#define L_SEVXB(index)     TEXT(32, index)
#define L_SHO(index)       TEXT(33, index)
#define L_SILO(index)      TEXT(34, index)
#define L_STAT(index)      TEXT(35, index)
#define L_TRA(index)       TEXT(36, index)
#define L_WAX(index)       TEXT(37, index)
#define L_GUN(index)       TEXT(38, index)
#define L_TITLE(index)     TEXT(39, index)
#define L_MPMENU(index)    TEXT(40, index)
#define L_PROPOBJ(index)   TEXT(41, index)
#define L_MPWEAPONS(index) TEXT(42, index)
#define L_OPTIONS(index)   TEXT(43, index)
#define L_MISC(index)      TEXT(44, index)
#define L_UFF(index)       TEXT(45, index)
#define L_OLD(index)       TEXT(46, index)
#define L_ATE(index)       TEXT(47, index)
#define L_LAM(index)       TEXT(48, index)
#define L_MP1(index)       TEXT(49, index)
#define L_MP2(index)       TEXT(50, index)
#define L_MP3(index)       TEXT(51, index)
#define L_MP4(index)       TEXT(52, index)
#define L_MP5(index)       TEXT(53, index)
#define L_MP6(index)       TEXT(54, index)
#define L_MP7(index)       TEXT(55, index)
#define L_MP8(index)       TEXT(56, index)
#define L_MP9(index)       TEXT(57, index)
#define L_MP10(index)      TEXT(58, index)
#define L_MP11(index)      TEXT(59, index)
#define L_MP12(index)      TEXT(60, index)
#define L_MP13(index)      TEXT(61, index)
#define L_MP14(index)      TEXT(62, index)
#define L_MP15(index)      TEXT(63, index)
#define L_MP16(index)      TEXT(64, index)
#define L_MP17(index)      TEXT(65, index)
#define L_MP18(index)      TEXT(66, index)
#define L_MP19(index)      TEXT(67, index)
#define L_MP20(index)      TEXT(68, index)
