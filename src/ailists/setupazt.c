...
u8 func100c_spawn_dd_guards[] = {
	...
	// 1
	if_stage_flag_eq(STAGEFLAG_OUTRO_STARTED, TRUE, /*goto*/ 0x0f)
	try_spawn_chr_at_pad(BODY_DD_GUARD, HEAD_RANDOM, PAD_AZT_0126, AILIST_SPAWNED_GUARD, SPAWNFLAG_00000200, /*goto*/ 0x68)
	goto_next(0x98)

	// 2
	label(0x69)
	if_stage_flag_eq(STAGEFLAG_OUTRO_STARTED, TRUE, /*goto*/ 0x0f)
	try_spawn_chr_at_pad(BODY_DD_GUARD, HEAD_RANDOM, PAD_AZT_00E5, AILIST_SPAWNED_GUARD, SPAWNFLAG_00000200, /*goto*/ 0x68)
	goto_next(0x98)

	// 3
	label(0x6a)
	if_stage_flag_eq(STAGEFLAG_OUTRO_STARTED, TRUE, /*goto*/ 0x0f)
	try_spawn_chr_at_pad(BODY_DD_GUARD, HEAD_RANDOM, PAD_AZT_0130, AILIST_SPAWNED_GUARD, SPAWNFLAG_00000200, /*goto*/ 0x68)
	goto_next(0x98)

	// 4
	label(0x6b)
	if_stage_flag_eq(STAGEFLAG_OUTRO_STARTED, TRUE, /*goto*/ 0x0f)
	try_spawn_chr_at_pad(BODY_DD_GUARD, HEAD_RANDOM, PAD_AZT_00FD, AILIST_SPAWNED_GUARD, SPAWNFLAG_00000200, /*goto*/ 0x68)
	goto_next(0x98)
...
u8 func100a_check_president_dead[] = {
	beginloop(0x06)
		if_chr_deadish(CHR_PRESIDENT, /*goto*/ 0x31)
	endloop(0x06)
...
u8 func100b_check_clone_dead[] = {
	beginloop(0x06)
		if_chr_deadish(CHR_PRES_CLONE, /*goto*/ 0x31)
	endloop(0x06)
...
u8 func041c_president_waiting[] = {
	...
	if_chr_deadish(CHR_SELF, /*goto*/ 0x08)
	goto_next(0x31)
...
u8 func100e_check_robots_left[] = {
	beginloop(0x06)
		if_chr_deadish(CHR_ROBOT1, /*goto*/ 0x31)
		...
		label(0x31)
		if_chr_deadish(CHR_ROBOT2, /*goto*/ 0x31)
		...
		label(0x31)
		if_chr_deadish(CHR_ROBOT3, /*goto*/ 0x31)
		...
		label(0x31)
		if_chr_deadish(CHR_ROBOT4, /*goto*/ 0x31)
...
u8 func100f_check_end_level[] = {
	...
	// Jo or Velvet alive
	label(0x08)
	if_chr_deadish(CHR_PRESIDENT, /*goto*/ 0x32)
